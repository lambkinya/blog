...
public class YaIpUtil {
     ...
     *
     * @param ip 客户端请求 IP
     * @return com.lambkin.blog.ya.YaIpBean
     */
    public static YaIpBean obtainClientLocationByIp(String ip) {
        YaIpBean location = new YaIpBean();
        location.setIp(ip);
        try (InputStream inputStream = YaIpUtil.class.getResourceAsStream("/ip2region.xdb")) {
