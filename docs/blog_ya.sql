-- No.1 建库
CREATE DATABASE IF NOT EXISTS blog_ya DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;



-- No.2 建表
/*
   coder, article, category, tag, comment
   tree_hole, wei_yan, web_info, friend_link
   coder_resource, sweetheart, history_info
...
CREATE TABLE IF NOT EXISTS `coder` (
    ...
    `yn` tinyint(1) DEFAULT '0' COMMENT '删除标志（0代表未删除，1代表已删除）',
    PRIMARY KEY (`id`),
    UNIQUE KEY `unique_username` (`username`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Coder';
...
CREATE TABLE IF NOT EXISTS `article` (
    ...
    `tag_no` varchar(32) DEFAULT NULL COMMENT '所属标签编号',
    ...
    `view_status` tinyint(1) NOT NULL COMMENT '文章状态（0草稿，1.公开，2.仅自己可见，3...）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='微言表';
...
CREATE TABLE `website_info` (
                            ...
                            `yn` tinyint(1) DEFAULT '0' COMMENT '删除标志（0代表未删除，1代表已删除）',
                            PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='网站信息表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='coder资源信息表';
...
CREATE TABLE `sweetheart` (
                              ...
                              `yn` tinyint(1) DEFAULT '0' COMMENT '删除标志（0代表未删除，1代表已删除）',
                              PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='恋人表';
...
CREATE TABLE `history_info` (
                                ...
                                `yn` tinyint(1) DEFAULT '0' COMMENT '删除标志（0代表未删除，1代表已删除）',
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='历史信息';
...
CREATE TABLE `im_chat_group_member` (
                                        ...
                                        `yn` tinyint(1) DEFAULT '0' COMMENT '删除标志（0代表未删除，1代表已删除）',
                                        PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='聊天群成员表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='单聊记录表';
...
CREATE TABLE `im_chat_group_message` (
                                         ...
                                         `yn` tinyint(1) DEFAULT '0' COMMENT '删除标志（0代表未删除，1代表已删除）',
                                         PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='群聊记录表';




-- No.3 初始化数据
INSERT INTO `coder` (`id`, `no`, `username`, `password`, `gender`, `avatar`, `website`, `github`, `gitee`, `email`, `phone`, `type`, `saying`, `status`, `create_time`, `update_time`, `version`, `yn`) VALUES (1, 'YA238192378218', 'lambkinya', '$2a$10$i.tORE2bNlF92nq0AmOkZ.ymg4aVxwbGzpNIYpLmoMRvaT92hrqgO', 0, 'http://s10nnt6yg.hb-bkt.clouddn.com/2023/09/16/YA251651564-e49da37d9989481b845648d1a32986a9.png', 'http://lambkinya.com', '', '', '', '', 0, '', 1, '2023-09-17 12:58:57', '2023-09-17 12:58:57', 0, 0);

INSERT INTO `im_chat_group` (`id`, `no`, `master_no`, `group_name`, `avatar`, `introduction`, `notice`, `in_type`, `group_type`, `create_time`, `update_time`, `version`, `yn`) VALUES (1, 'GN27389134783', '1', '公共聊天室', NULL, '公共聊天室', NULL, 1, 1, '2023-09-17 12:53:41', '2023-09-17 12:53:41', 0, 0);

INSERT INTO `im_chat_group_member` (`id`, `no`, `group_no`, `coder_no`, `verify_coder_no`, `remark`, `admin_flag`, `coder_status`, `create_time`, `update_time`, `version`, `yn`) VALUES (1, 'GMN3279872', '-1', 'YA238192378218', NULL, NULL, 1, 1, '2023-09-17 12:57:39', '2023-09-17 12:57:39', 0, 0);

INSERT INTO `website_info` (`id`, `no`, `name`, `title`, `notices`, `footer`, `background_image`, `avatar`, `random_avatar`, `random_name`, `random_cover`, `waifu_json`, `status`) VALUES(1, 'WIN4648465468441', 'Lambkin', '花灯随烟波铺江上', '[]', '月下闲读，红袖添香。', '', '', '[]', '[]', '[]', '{
  "mouseover": [
    {
      "selector": "#live2d",
      "text": [
